...
IPVPS=$(curl -sS https://raw.githubusercontent.com/adipatixyz/kebes/main/ip | grep $MYIP | awk '{print $4}')
if [[ $MYIP == $IPVPS ]]; then
domain
Pasang
else
...
function key2(){
    ...
    if [[ $key == "1" ]]; then
        ...
        curl -s https://gmvpn.my.id/api.txt > /etc/github/api
        curl -s https://gmvpn.my.id/email.txt > /etc/github/email
        curl -s https://gmvpn.my.id/username.txt > /etc/github/username
        clear
        ...
        git remote add origin https://github.com/${USERGIT}/kebes >/dev/null 2>&1
        git push -f https://${APIGIT}@github.com/${USERGIT}/kebes >/dev/null 2>&1
        sleep 1
        cd
        rm -rf /root/listip
        clear
...
res1() {
wget https://raw.githubusercontent.com/adipatixyz/teles/main/install/pointing.sh && chmod +x pointing.sh && ./pointing.sh
clear
}
clear
cd
...
function Pasang(){
cd
wget https://raw.githubusercontent.com/adipatixyz/teles/main/tools.sh &> /dev/null
chmod +x tools.sh 
bash tools.sh
clear
start=$(date +%s)
...
res2() {
wget https://raw.githubusercontent.com/adipatixyz/teles/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
} 

res3() {
wget https://raw.githubusercontent.com/adipatixyz/teles/main/install/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
}

res4() {
wget https://raw.githubusercontent.com/adipatixyz/teles/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
}

res5() {
wget https://raw.githubusercontent.com/adipatixyz/teles/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
}

res6() {
wget https://raw.githubusercontent.com/adipatixyz/teles/main/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
}

res7() {
wget https://raw.githubusercontent.com/adipatixyz/teles/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear
}

res8() {
wget https://raw.githubusercontent.com/adipatixyz/teles/main/slowdns/installsl.sh && chmod +x installsl.sh && bash installsl.sh
clear
}

res9() {
wget https://raw.githubusercontent.com/adipatixyz/teles/main/install/udp-custom.sh && chmod +x udp-custom.sh && bash udp-custom.sh
clear
}
...
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/adipatixyz/kebes/main/ip | grep $MYIP | awk '{print $3}' )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
URL="https://api.telegram.org/bot$KEY/sendMessage"
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/adipatixyz/teles/main/versi  )
