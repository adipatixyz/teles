...
# Link Hosting Kalian
wget -O /usr/bin/ws "https://raw.githubusercontent.com/adipatixyz/teles/main/sshws/ws"
chmod +x /usr/bin/ws
...
wget -O /usr/local/bin/ws-ovpn "https://raw.githubusercontent.com/adipatixyz/teles/main/sshws/ws"
